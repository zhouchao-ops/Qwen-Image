...
class MyQwenImageEditPipeline(QwenImageEditPipeline):
    ...
    def __call__(
        ...
        negative_prompt_embeds_mask = negative_prompt_embeds_mask.to(device)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if do_true_cfg:
                    negative_prompt_embeds = negative_prompt_embeds.to(self.transformer.device)
                    negative_prompt_embeds_mask = negative_prompt_embeds_mask.to(self.transformer.device)
...
if __name__ == "__main__":
    ...
    pipeline = MyQwenImageEditPipeline.from_pretrained("Qwen/Qwen-Image-Edit", torch_dtype=torch.bfloat16)
    # pipe = pipe.to("cuda")
